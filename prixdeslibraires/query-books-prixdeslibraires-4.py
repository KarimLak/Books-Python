...
def scrape_book(url, award):
    ...
    book_data = {
        ...
        'description': (award_string[1:] if award_string.startswith(' ') and 'Lauréat' not in award_string else award_string) + ' : 2023 poésie',
    }

    return book_data

url = 'https://prixdeslibraires.qc.ca/categorie-poesie-quebecoise-selection/'
button_texts = ['Préliminaire 2023', 'Finalistes 2023 poésie', 'Lauréat 2023 poésie']
...
with open("output-prixdeslibraires-poesie.ttl", "w", encoding="utf-8") as f:
