...
def scrape_book(url, award):
    ...
    description = (award_string[1:] if award_string.startswith(' ') and 'Lauréat' not in award_string else award_string) + (' : BD Jeunesse' if 'BD' in award_string else ' : 2023 volet adulte')
    ...
    book_data = {
        ...
        'summary': summary,
        'genre': 'Jeunesse' if 'Jeunesse' in description else 'Adulte',
        'url': url,
        'datePublished': '2022',
...
url = 'https://prixdeslibraires.qc.ca/categorie-bd-selection-2023/'
button_texts = ['Finalistes BD Jeunesse', 'Préliminaire BD Jeunesse', 'Préliminaire volet adulte', 'Lauréats BD Jeunesse', 'Finalistes 2023 volet adulte', 'Lauréats 2023 volet adulte']
...
with open("output-prixdeslibraires-bd.ttl", "w", encoding="utf-8") as f:
